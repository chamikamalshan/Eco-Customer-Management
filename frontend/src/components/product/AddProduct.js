...
export default function AddProduct(){
  ...
  function sendData(e){
    ...
    if(pname.length==0||price.length==0||pstock.length==0)
    setError(true)
    if(pname&&price&&pstock)
    {
      console.log("PName:",pname,"Price:",price,"PStock:",pstock)
    }
    ...
    return(
          ...
          <div class="card bg-dark text-white" >
           <img src="financebg.png" class="card-img" alt="..." style={{height: '375px', filter: 'brightness(40%)'}}/>
             <div class="card-img-overlay">
              <br></br>
              <br></br>
                <h1 class="card-title" style={{fontSize: '90px'}}><b>ADD</b> <b class="text-success">PRODUCT</b></h1>
                <br></br>
                <br></br>
                <br></br>
        ...
        <div class="card-body"> 
        <br></br>
        <h1 class="card-title text-success"><b>ADD PRODUCT DETAILS</b></h1>
        <br></br>
