...
export default function AllStaffMembers(){
    ...
    useEffect(()=>{
        function getStaffMembers() {
            axios.get("http://localhost:8070/staffmember/allsmember").then((res)=>{
   ...
   const deleteSMember= async(id)=>{
    console.warn(id)
    let result = await fetch(`http://localhost:8070/staffmember/deletesmember/${id}`,{
        method:"Delete"
    });
        ...
        <div class="card bg-dark text-white" >
           <img src="financebg.png" class="card-img" alt="..." style={{height: '375px', filter: 'brightness(40%)'}}/>
             <div class="card-img-overlay">
              <br></br>
              <br></br>
                <h1 class="card-title" style={{fontSize: '90px'}}><b>ALL STAFF</b> <b class="text-success">MEMBERS</b></h1>
                <br></br>
                <br></br>
                <br></br>
        ...
        <table class="table table-success table-striped">
            ...
            {staffmembers.filter((staffmembers) => {
                ...
                <tr key={staffmembers._id}>
                    ...
                    <td>
                        <a className="btn btn-success" href={`/updatesmember/${staffmembers._id}`}>
                            <i className="fas fa-edit"></i>&nbsp;Update
                        </a>

                        <h>    </h>
                        
                        <a className="btn btn-secondary" href="#" onClick={()=>deleteSMember(staffmembers._id)}>
